...
function Hero() {
  ...
  return (
    <section
      id="Hero"
      className="relative flex items-center text-prim py-13 justify-end md:py-20 md:h-screen"
    >
      {/* Background Video */}
      ...
      <div className="relative flex md:flex-row md:w-full ">
        ...
        <div className="flex flex-col items-center md:items-start  p-3 rounded-md mr-0 md:backdrop-blur-none md:shadow-none md:mr-0 md:bg-transparent md:flex-1 md:pl-50">
          <h3 className="hidden md:block font-ad text-xl md:px-0 md:text-3xl lg:text-4xl font-bold text-prim pb-1">
            Confirm Your Attendance
          </h3>
          
          <h3 className="md:hidden font-ad text-xl md:px-0 md:text-3xl font-bold text-prim pb-1">
            Confirm Attendance
          </h3>
          <div className="hero-crown-divider">
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none z-10 transform rotate-180">
        <svg
          ...
          className="relative block w-full h-5 md:h-17 drop-shadow-[0_-7px_6px_rgba(0,0,0,0.9)]"
        >
          {/* Fill layer — no stroke */}
          <path
          ...
          {/* Wave curve only — no fill, gold stroke on top edge only */}
          <path
